...
// Define styles for the modal dialog
const MODAL_STYLES = {
    position: 'fixed',
    top: '50%',
    left: '50%',
  ...
  // Define styles for the character picture
  const PIC_Style = {
    border: '2px',
    width: '220px',
        ...
        <div style={MODAL_STYLES} className='container'>
          ...
          <div className='row'>
            ...
            <div className='col'>
              ...
              <a href={Cdata.url} target='_blank' style={LINK_STYLE} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}><b>Character API</b></a>
            </div>
          </div>
